...
public class DtoAssembler {
    ...
    public static ContractDto toDto(Contract arg) {
        ...
        result.contractType.name = arg.getContractType().getName().toString();
        result.contractType.compensationDaysPerYear = arg.getContractType()
        ...
        result.professionalGroup.productivityRate = arg.getProfessionalGroup()
            .getProductivityRate();
        result.professionalGroup.trieniumPayment = arg.getProfessionalGroup()
            .getTrienniumPayment();
