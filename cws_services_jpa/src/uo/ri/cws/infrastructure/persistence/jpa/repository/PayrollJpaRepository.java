...
public class PayrollJpaRepository extends BaseJpaRepository<Payroll>
    ...
    @Override
    public double grossSalaryOfTheLastYear(String id,
            LocalDate endDateOneYearAgo, LocalDate endDate) {

        return Jpa.getManager()
            .createNamedQuery("Payroll.grossSalaryOfTheLastYear", double.class)
            .setParameter(1, id)
            .setParameter(2, endDateOneYearAgo)
